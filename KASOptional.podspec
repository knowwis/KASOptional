#
#  Be sure to run `pod spec lint KASOptional.podspec' to ensure this is a
...
It allows to specify there is value or not without more clearly. You should not assume nil(NULL) is not a value. Now you can ask it about stored value
  ...
  s.author             = "Kalita Alexey"
  # Or just: s.author    = "KalitaAlexey"
  # s.authors            = { "KalitaAlexey" => "KalitaA@ksi.ru" }
  # s.social_media_url   = "http://twitter.com/KalitaAlexey"
  ...
  s.source       = { :git => "https://github.com/knowwis/KASOptional.git", :tag => "1.0.0" }
